...
cityscapes_data_path = "/data/DATASET/Cityscape"
cityscapes_meta_path = "/data/DATASET/Cityscape/gtFine"
...
for train_dir in train_dirs:
    ...
    for file_name in file_names:
        ...
        gtFine_img_path = train_label_dir_path + img_id + "_gtFine_labelIds.png"  # source label image
